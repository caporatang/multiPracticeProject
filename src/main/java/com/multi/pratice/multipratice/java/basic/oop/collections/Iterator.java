package com.multi.pratice.multipratice.java.basic.oop.collections;

/**
 * packageName : com.multi.pratice.multipratice.java.basic.oop.collections
 * fileName : Iterator
 * author : taeil
 * date : 2023/04/18
 * description :
...
public class Iterator {
    ...
    // 순서가 있는 List 인터페이스의 경우는 Iterator를 사용하지 않고 get(i)로도 가능.
